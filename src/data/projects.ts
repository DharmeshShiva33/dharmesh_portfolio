...
export const PROJECTS_DETAILS: Project[] = [
  ...
  },
  {
    ...
    details: {
      ...
      features: [
        ...
        "Integrated multiple REST APIs to fetch and display dynamic data on different pages.",
  ...
  },
  {
    ...
    title: "Lead Detector",
    description:
      "Lead Detector helps turn anonymous website visitors into real leads by tracking their activity and enriching their data.",
    image: "/QualiFi.png",
    tech: [
      "Angular16",
      "Angular Material",
    ...
    details: {
      overview:
        "Lead Detector is a platform that helps identify website visitors even if they don’t fill out any forms. It tracks anonymous users and, using third-party data and skip tracing, converts them into actual leads by gathering useful details like phone numbers, addresses, and company information.",
      role: "Frontend Developer",
      features: [
        "Developed UI components using Angular 18 and Angular Material with a custom SCSS theme.",
        "Integrated multiple REST APIs to fetch and display dynamic data on different pages.",
      ...
      challenges:
        "make the application responsive and handle dynamic API data effectively.",
      outcome:
        "Improve UI consistency and performance across devices, resulting in a better user experience and more effective lead conversion.",
    },
  },
  {
    id: 6,
    title: "Minute Pages",
    description:
      "A white-label platform to create, manage, and convert WordPress-based websites and leads efficiently.",
    image: "/RocketSites.png",
    tech: [
      "Angular16",
      "CodeIgniter",
      "TypeScript",
    ...
    live: "https://app.rocketsites.ai/",
    github: "#",
    details: {
      overview: `I worked on a white-label application that allows users to clone a predefined WordPress theme into a new website within minutes using their own domain.
      The platform lets users easily manage pages, leads, posts, payments (including refunds), subscription plans, and Google Analytics from a single dashboard.
      I was involved in building the frontend using Angular and integrating it with a CodeIgniter backend, along with shell scripts and WordPress automation. I also worked on maintaining WordPress security and implementing skip tracing to convert leads into complete customer data.`,
      role: "Frontend Developer",
      features: [
        "Create a multiple Module Pages UI Designed and make it responsive",
        "Solved UI 90% of the UI issues and made the application responsive across all devices",
        "Structured the application using modular architecture and implemented Lazy Loading for performance optimization",
        "Created reusable UI components to maintain consistency across the application",
      ],
      challenges: "Maintaining consistency across devices.",
      outcome: "Improved UI consistency and performance across devices.",
    },
  },
  {
    id: 3,
